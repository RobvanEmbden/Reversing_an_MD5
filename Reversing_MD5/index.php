...
<head>
    <title>Rob van Embden MD5 Cracker</title>
</head>

<body>
    <h1>MD5 cracker</h1>
    <p>This application takes an MD5 hash of a four digit pin and check all 10,000 possible four digit PINs to determine
        the PIN.</p>
    <pre>
Debug Output:
<?php
...
if ( isset($_GET['md5']) ) {
    ...
    $txt = "1234567890"; //"abcdefghijklmnopqrstuvwxyz";
    $show = 15;
